...
public class AdVpnService extends VpnService implements Handler.Callback {
  ...
  private final NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(
      this)
  ...
  public int onStartCommand(@Nullable Intent intent, int flags, int startId) {
    ...
    switch (intent == null ? Command.START : Command
      ...
      case START:
        startVpn(intent == null
                 ? null
                 : (PendingIntent) intent.getParcelableExtra("NOTIFICATION_INTENT"));
        break;
      case STOP:
        stopVpn();
        break;
  ...
  private void startVpn(PendingIntent notificationIntent) {
    ...
    registerReceiver(connectivityChangedReceiver,
