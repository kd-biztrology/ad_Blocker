...
public class MainActivity extends AppCompatActivity {
  ...
  private final BroadcastReceiver vpnServiceBroadcastReceiver = new BroadcastReceiver() {
    ...
    public void onReceive(Context context, Intent intent) {
      int str_id = intent.getIntExtra(AdVpnService.VPN_UPDATE_STATUS_EXTRA,
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    int[] tabColors = { R.color.colorBottomNavigationPrimary, R.color.colorBottomNavigationPrimary,
        R.color.colorBottomNavigationPrimary, R.color.colorBottomNavigationPrimary,
        R.color.colorBottomNavigationPrimary, };
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode == REQUEST_FILE_OPEN && resultCode == RESULT_OK) {
      ...
      try {
        ...
        newConfig.read(new JsonReader(
            new InputStreamReader(getContentResolver().openInputStream(selectedfile))));
        config = newConfig;
      } catch (Exception e) {
  ...
  private void updateStatus(int status) {
    ...
    TextView stateText = (TextView) viewPager.getChildAt(0)
        .getRootView()
  ...
  protected void onResume() {
    ...
    LocalBroadcastManager.getInstance(this)
        .registerReceiver(vpnServiceBroadcastReceiver,
